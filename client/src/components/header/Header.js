...
export default class Header extends Component{
    ...
    state = {
        ...
        logpassword:'',
        logemail:'',
        formError:{email:'',password:'',regname:'',regemail:'',regpass:'',regpassconf:'',regphone:''},
        emailvalid:false,
        passvalid:false,
        formValid:false,
...
/// FUNCTION FOR OPEN SIGNIN OR SIGN UP WINDOWS HANGED ON THEIR NUMBERS
    ...
    validateField = (fieldName,fieldvalue) =>{
        ...
        let regphonevalid = this.state.regphonevalids;
        switch(fieldName){
            ...
            formerror.regpassconf = regpassconfirmvalid ? '' : 'redborder';
                break;
            case 'phone' : regphonevalid = fieldvalue.match(/^[0-9\b]+$/) && fieldvalue.length < 12;
            formerror.regphone = regphonevalid ? '' : 'redborder';
    ...
    validateForm=()=>{
        this.setState({
            ...
            regFormvalid: this.state.namevalid && this.state.regpassvalid && this.state.regmailvalid && this.state.regpassconfirm && this.state.regphonevalids
                    ...
                    <div className={'headupcontainer'}>
                        <ul>
                            {this.state.headup.map((e,i)=>{
                                return(
                                    <li className='pzik'  key={i} onClick={this.signin.bind(this,i)}>
                                        <i className={e.i}/>
                                        <a href="1">{e.txt}</a>
                                    </li>
                                )
                    ...
                    <div className={'inpabsolute'}>
                        <div className={"inpabsone"}>
                            ...
                            <form onSubmit={this.onSubmits}>
                                ...
                                <div className={'signinform'}>
                                    <input type="text" className={`signname ${this.errorClass(this.state.formError.regphone)}`}  name="phone" onChange={this.onChange} placeholder={'Enter Your Phone'}/>
                                </div>
                                <div className={'signinform'}>
